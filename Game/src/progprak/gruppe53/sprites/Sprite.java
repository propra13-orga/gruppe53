...
abstract public class Sprite implements Drawable, Movable, Serializable {
	...
	public Rectangle2D.Double getHorizontalCollsionRect() {
		return new Rectangle2D.Double((int) (getX() + dx), (int) (getY()),
				(int) getWidth(), (int) getHeight());
	}

	public Rectangle2D.Double getVerticalCollsionRect() {
		return new Rectangle2D.Double((int) (getX()), (int) (getY() + dy),
				(int) getWidth(), (int) getHeight());
	}
	 ...
	 * IOException { s.defaultWriteObject(); }
	 * 
	...
	public String toString() {
		return super.toString() + "[x:" + x + "y:" + y + "h:" + height + "w:"
				+ width + "]";
	}
}
